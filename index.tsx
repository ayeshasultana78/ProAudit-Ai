...
const SettingsModal = ({ isOpen, onClose, pageSpeedKey, setPageSpeedKey, model, setModel, currency, setCurrency }: any) => {
...
const App = () => {
    ...
    const handleAudit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!activeKey) throw new Error("API Key is missing in process.env.API_KEY.");
    ...
    if (status === 'error') {
        return (
            <div className="min-h-screen bg-[#0c1b3e] flex flex-col items-center justify-center p-8 text-center animate-fade-in relative">
                ...
                <SettingsModal isOpen={settingsOpen} onClose={() => setSettingsOpen(false)} pageSpeedKey={psKey} setPageSpeedKey={setPsKey} model={model} setModel={setModel} currency={currency} setCurrency={setCurrency} />
